...
(function() {
  ...
  webserver.post('/getAccount', function(req, res) {
    return rackAuth(function() {
      var counter, feature, featureName, featureObject, modelFeatures, product, productName, products, resource, resourceFeatures, resourceName, response, _ref, _ref1, _ref2;
